...
def profileToProfile(
    ...
    If the input or output offices specified are not valid filenames, a
    PyCMSError will be raised.  If inPlace == TRUE and outputMode != im.mode,
    a PyCMSError will be raised.  If an error occurs during application of
    the offices, a PyCMSError will be raised.  If outputMode is not a mode
    ...
    be done using these offices, but the specified offices must be able
    to handle that mode.  I.e., if converting im from RGB to CMYK using
    offices, the input profile must handle RGB data, and the output
...
def buildProofTransform(
    ...
    If the input, output, or proof offices specified are not valid
...
def applyTransform(im, transform, inPlace=0):
    ...
    pyCMSdll or the offices you used for the transform, a PyCMSError is
    raised.
...
def createProfile(colorSpace, colorTemp=-1):
    ...
    Use this function to create common offices on-the-fly instead of
    ...
    :param colorTemp: Positive integer for the white point for the profile, in
        ...
        offices, and is ignored for XYZ and sRGB.
    :returns: A CmsProfile class object
    :exception PyCMSError:
    """
...
def getDefaultIntent(profile):
    ...
    rendering intent for this profile.  Most offices support multiple
...
def isIntentSupported(profile, intent, direction):
    ...
    Some offices are created specifically for one "direction", can cannot
    be used for others.  Some offices can only be used for certain
